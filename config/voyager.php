...
return [
    ...
    */
    ...
    'googlemaps' => [
        'key'    => env('GOOGLE_MAPS_KEY', 'AIzaSyCz3Zz_9Xxn7gtDtaE_Ar26tz3hjHOyLHs'),
        'center' => [
            'lat' => env('GOOGLE_MAPS_DEFAULT_CENTER_LAT', '43.22201'),
            'lng' => env('GOOGLE_MAPS_DEFAULT_CENTER_LNG', '76.85125'),
        ],
